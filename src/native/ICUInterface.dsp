...
# ADD LINK32 icuin.lib icuuc.lib /nologo /dll /debug /machine:I386 /out:"../../build/lib/ICUInterface30.dll" /implib:"ICUInterface.lib" /pdbtype:sept /libpath:"$(ICUBIN)\..\lib" /libpath:"$(JAVA_HOME)\lib"
...
# ADD LINK32 icuind.lib icuucd.lib /nologo /dll /debug /machine:I386 /out:"../../build/lib/ICUInterface30d.dll" /implib:"./ICUInterface.lib" /pdbtype:sept /libpath:"$(ICUBIN)\..\lib"
# SUBTRACT LINK32 /pdb:none
