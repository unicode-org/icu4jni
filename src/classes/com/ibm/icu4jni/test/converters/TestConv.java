 ...
 static byte [] bytes;
    ...
    public static void main (String[] args) {
        ...
        String encoding[] ={ "GB18030",
            ...
            testToUnicode(encoding[0]);
            testFromUnicode(encoding[0]);
    ...
    private final static void javaTest(String encoding){
            ...
            try {
                ...
                System.out.println("FromChars - exception in single buffer");
                e.printStackTrace(System.err);
                rc = 9;
            }
            if (rc==0) {
    ...
    public static boolean equals(byte [] b1, byte [] b2) {
      ...
      private static void testFromUnicode(String encoding){
        try{
            byte[] myTarget = new byte[uSource.length * 5]; 
      ...
      private static void testToUnicode(String encoding){
         try{
            ...
            testSmOutBufToUnicode(gbConv,encoding);
      ...
      public static void testSmOutBufFromUnicode(CharToByteConverter gbConv,String encoding){
...
//            try{
                ...
                if(passed){
                    ...
                    System.out.println("--Test small output buffers "+encoding+" from Unicode --FAILED");
                }
                testSmOutBufFromUnicode(gbConv,encoding);
 ...
 /*           }
        ...
        {            
           // try{
                ...
                if(passed){
                    ...
                    System.out.println("--Test small input buffers "+encoding+" from Unicode --FAILED");
                }
      ...
      public static void testSmOutBufToUnicode(ByteToCharConverter  gbConv,String encoding){
         ...
         }
         {
           // try{
                ...
                if(passed){
                    System.out.println("--Test small output buffers "+encoding+" TO Unicode--PASSED");
                }else{
                    System.out.println("--Test small output buffers "+encoding+" TO Unicode --FAILED");
                }
           ...
           // try{
               // ByteToCharConverter gbConv = ByteToCharConverter.getConverter("gb18030");
                ...
                if(passed){
                    ...
                    System.out.println("--Test small input buffers "+encoding+"TO Unicode --FAILED");
                }
          /*  }
            catch(UnsupportedEncodingException ueEx){
                    System.out.println(ueEx.toString());
      ...
      public static void testConvertAll(String encoding){
        {
            try{
                //char[] myTarget = new char[gbSource.length];
                byte[] mySource = new byte[gbSource.length];
 ...
 public static void multiThreadedTest(final String encoding){
        //while(true){
        try{
                    ...
                    synchronized(bcConv1){
                        while(!interrupted()){
                            try{
                                ...
                                testSmOutBufToUnicode(bcConv,encoding);
                                testSmOutBufFromUnicode(cbConv,encoding);
                            }
                            catch(UnsupportedEncodingException ueEx){
                                System.out.println(ueEx.toString());
                            }
                ...
                public void run(){
                    synchronized(bcConv2){
                        while(!interrupted()){
                            try{
                                final ByteToCharConverter bcConv = ByteToCharConverterICU.createConverter(encoding);
                                testSmOutBufToUnicode(bcConv2,encoding);
                                testSmOutBufToUnicode(bcConv,encoding);
                            }
                            catch(UnsupportedEncodingException ueEx){
                                System.out.println(ueEx.toString());
            ...
            Thread t3 = new Thread(){
                public void run(){
                   synchronized(cbConv1){
                        while(!interrupted()){
                            testSmOutBufFromUnicode(cbConv1,encoding);
                        }
                   }
                }
            };
            ...
            Thread t4 = new Thread(){
                public void run(){
                   synchronized(cbConv2){
                       while(!interrupted()){
                            testSmOutBufFromUnicode(cbConv2,encoding);
                       }
                   }
                }
            };
      ...
      public static void testCallback(String encoding){
...
//                gbConv.convert(mySource, 0, mySource.length, myTarget, 0, myTarget.length);
     ...
     public static void testCanConvert(String encoding){
          try{
            char[] mySource= {
                    '\ud800','\udc00',/*surrogate pair */
                    '\u22A6','\u22A7','\u22A8','\u22A9','\u22AA',
